...
* ["YUI": http://developer.yahoo.com/yui/]: The YUI Library is a set of utilities and controls, written in JavaScript, for building richly interactive web applications using techniques such as DOM scripting, DHTML and AJAX.

* ["Caja": http://code.google.com/p/google-caja/]: A source-to-source translator for securing Javascript-based web content
